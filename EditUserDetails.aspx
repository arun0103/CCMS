        ...
        <fieldset>
            ...
            <asp:Panel ID="panelWrapper" runat="server" Visible="False">
                ...
                <div id="left-part-user-info" style="float: left; width: 300px;">
                    <table cellspacing="10px" style="font-size: 14px" class="all-texts">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="passwordV" runat="server" Font-Size="14px" Height="24px" BorderColor="#3366FF"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="updateButton" runat="server" Text="Update"
                                    ...
                                    BackColor="#CCCCFF" Height="33px" Width="76px"
