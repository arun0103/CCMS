...
namespace DWIT_HRM_System
{
    public partial class EditUserDetails : System.Web.UI.Page
    {
        ...
        public void Search()
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    passwordV.Text = dr["password"].ToString();
        ...
        protected void updateButton_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = @"UPDATE users SET password = @passwordV, FirstName = @firstnameV, LastName = @lastnameV, active = @statusV, role = @roleV WHERE userEmail = @searchbox";

            cmd.Parameters.AddWithValue("@passwordV", passwordV.Text);
